		...
		<div data-minecraft-charsheet="root">
			<div>
				...
				<div data-minecraft-charsheet="stats">
					...
					<ul>
						<li>
							<p data-dict=".">players/level</p>
							<xsl:value-of select="$lvl" />
						</li>
						<!-- <li> <xsl:text>Position: </xsl:text> </li> <li> <xsl:value-of select="$posX"/> <xsl:text>, </xsl:text> <xsl:value-of 
							select="$posY"/> <xsl:text>, </xsl:text> <xsl:value-of select="$posZ"/> </li> -->
						<li data-dict="">players/laston</li>
						<li>
							<time datetime="{$player/../@change-utc}">
								<xsl:value-of select="$player/../@change-datetime" />
							</time>
						</li>
						<li>
							<xsl:call-template name="image-bar">
